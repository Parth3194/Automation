...
driver.manage().window().maximize();
    ...
    @Test(dataProvider = "Register3", dataProviderClass = DataProvider_Register.class )
    
    public void Register1(String fn, String ln , String em ,String tel , String pw, String cpw){
   ...
   @Test (dataProvider = "Register4" , dataProviderClass = DataProvider_Register.class)
