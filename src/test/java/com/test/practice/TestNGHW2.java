...
public WebDriver driver ;
    ...
    public void Login1 (){
    	...
    	driver.findElement(By.cssSelector("input#input-email")).sendKeys("java9281111@sele.com");
    ...
    public void Login2 (){
        ...
        driver.findElement(By.cssSelector("input#input-email[name='email']")).sendKeys("java9711113@sele.com");
    	driver.findElement(By.cssSelector("input#input-password[name='password']")).sendKeys("Parth@3194");
    ...
    public void Login3 (){
    	...
    	driver.findElement(By.cssSelector("input[name='email']")).sendKeys("java96111@sele.com");
    	driver.findElement(By.cssSelector("input[name='password']")).sendKeys("Parth@3194");
